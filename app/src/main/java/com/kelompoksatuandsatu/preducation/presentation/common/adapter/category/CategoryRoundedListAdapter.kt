...
class CategoryRoundedListAdapter(
    private val viewModel: ProgressClassViewModel,
    private val itemClick: (CategoryType) -> Unit
) : RecyclerView.Adapter<CategoryRoundedListAdapter.LinearCategoryProgressItemViewHolder>() {
    ...
    class LinearCategoryProgressItemViewHolder(
        ...
        val viewModel: ProgressClassViewModel,
